--local lastSafeVersion = tonumber(game:HttpGet("https://raw.githubusercontent.com/iamtryingtofindname/Scripts8/main/games/Jailbreak/LastSafeVersion")) or -1 -- deprecated
-- Gui to Lua
-- Version: 3.2
...
Frame.Position = UDim2.new(0.853999972, 0, 0.5, 0)
...
-- code
local lastVersion = tonumber(readfile("last_jailbreak_version.txt"))
